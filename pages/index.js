  ...
  return (
    <>
      ...
      <div className="content">
        <h1> چین یار | دروازه ورود شما به بلاکچین بدون محدودیت </h1>
        <div className="d1">
           شما با شبکه به چین یار متصل هستید   :   
          {networkActive ? (
            <>
        ...
        <div className="groups">
          <div className="group vtools">
            <div className="title">سرویس ها برای ارائه در شبکه : {networkActive?.chainName}</div>
            <div className="items">
